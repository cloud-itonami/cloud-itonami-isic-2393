# Operator Quickstart — Manufacture of other porcelain and ceramic products

Shortest path from clone to a verified local dry-run for **ISIC 2393** (`cloud-itonami-isic-2393`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2393.git
cd cloud-itonami-isic-2393
```
...
- Blueprint governor key: `porcelain-ceramic-plant-operations-governor`
- Likely source path: `porcelainmfg.governor.cljc`
